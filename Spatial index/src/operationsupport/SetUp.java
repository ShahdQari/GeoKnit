...
public class SetUp {
	...
	public static void loadFiles(Ignite ignite, String path, int key, CacheInfo cacheInfo) {
 	...
 	public static void insert(Ignite ignite,CacheInfo cacheInfo)
 	...
 	public static void printCahces(Ignite ignite, CacheInfo cacheInfo) throws IOException {
 		int s=0;
 		OutputStreamWriter writer = new OutputStreamWriter(
				new FileOutputStream("D:\\CachesAndSize.txt", false), "UTF-8");
