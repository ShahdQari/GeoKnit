...
public class build_Rtree {
    ...
    public AbstractRTreeBBPartitioner RTree(String path, String path_out) throws IOException {
        ...
        try {
            ...
            while (sc.hasNextLine()) {
                ...
                double lat = Double.parseDouble(sections[1]);
                double lan = Double.parseDouble(sections[2]);
